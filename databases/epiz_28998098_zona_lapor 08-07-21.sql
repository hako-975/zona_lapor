...
-- Waktu pembuatan: 07 Jul 2021 pada 15.38
...
--
-- Database: `epiz_28998098_zona_lapor`
--
...
(1, 'Tanggapan Baik laporan Anda kami proses berhasil ditambahkan', '2021-07-06 05:58:34', 1),
(2, 'Tanggapan Laporan Anda valid, segera kami perbaiki berhasil ditambahkan', '2021-07-06 06:00:35', 1),
(3, 'Tanggapan Dalam pengerjaan berhasil ditambahkan', '2021-07-06 06:00:58', 1),
(4, 'Tanggapan Sudah selesai kami perbaiki. berhasil ditambahkan', '2021-07-06 06:01:14', 1),
(5, 'Tanggapan Baik kami segera mengecek ke TKP. berhasil ditambahkan', '2021-07-08 01:53:15', 2),
(6, 'Tanggapan Laporan Anda valid, segera kami perbaiki. berhasil ditambahkan', '2021-07-08 01:53:35', 2),
(7, 'Tanggapan dalam pengerjaan berhasil ditambahkan', '2021-07-08 01:53:49', 2),
(8, 'Tanggapan Jembatan sudah selesai diperbaiki. berhasil ditambahkan', '2021-07-08 01:54:31', 2),
(9, 'Tanggapan Baik segera kami proses. berhasil ditambahkan', '2021-07-08 02:01:49', 2),
(10, 'Tanggapan Laporan Anda valid. berhasil ditambahkan', '2021-07-08 02:03:14', 2),
(11, 'Tanggapan Jalan sedang dalam pengerjaan untuk diperbaiki. berhasil ditambahkan', '2021-07-08 02:04:08', 2),
(12, 'Tanggapan Jalanan selesai diperbaiki. berhasil ditambahkan', '2021-07-08 02:05:21', 2);
...
(1, 'Andre Farhan Saputra', 'andre123', '$2y$10$HNbV4OOp5EeS6eqhN5ElCeCW51JTxPrjwIc/s6cRLzM/26cQG4jg2', '087733932416', 'Jl. AMD Babakan Pocis No. 100 RT02/02'),
(2, 'Muhammad Irgi Al Ghithraf', 'irgi5', '$2y$10$w507c8b4Dj0oi6sMHGUPcuZyoQ0KAlZUwQwerzOrPzCEdmC2Yzj.W', '085773094859', 'Perum Puri Serpong 1 Blok D5 No. 7 RT 08/02 Setu, Setu, Tangerang Selatan, Banten'),
(3, 'Ableza Melani Putri', 'ableza24', '$2y$10$Ke4Rs03V8CcpxCQ0gER.BuM2Hb34u5mbyWsNHzBdaJHvlW1cWEoMy', '089677646147', 'JL. AMD Babakan Pocis No. 7 RT 02/01 Bakti Jaya Setu Kota Tangerang Selatan'),
(4, 'Annisa Ulazijah Faqih', 'annisa98', '$2y$10$qRMaK628E04p2wjsyL9RNuBArIfsm7OWT44MB4do4F4AOlVYSbMeO', '087808564812', 'Kp. Jaletreng No. 41 RT 03/03 Serpong, Serpong'),
(5, 'Azzaura', 'azzaura56', '$2y$10$NRWn0q8RWuQm3SlPDwxL7ucLXRVkd1mHZN2eLplDtBZw5Yu3FgY0y', '085212984453', 'Perum Griya Cendekia No. 17 RT 05/06, Curug, Gunung Sindur');
